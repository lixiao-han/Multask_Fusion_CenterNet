...
def prefetch_test(opt):
  ...
  mAP_LXH, mAP_LXH_half, recall_LXH = dataset.run_eval_1(opt.save_dir, level_LXH)
  #结束1
  # 开始4
  '''
  split = 'test_easy'
  ...
  # 结束3
  #return mAP_LXH, mAP_LXH_half, mAP_LXH_easy, mAP_LXH_medium, mAP_LXH_hard, recall_LXH
  return mAP_LXH, mAP_LXH_hard, recall_LXH
