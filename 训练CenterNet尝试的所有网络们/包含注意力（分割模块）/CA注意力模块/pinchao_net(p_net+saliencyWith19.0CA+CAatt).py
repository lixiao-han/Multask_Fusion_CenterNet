...
class PoseResNet(nn.Module):
    ...
    def __init__(self, block, layers, heads, head_conv, **kwargs):
        ...
        self.down23=Down1(128,64)
        self.down35=Down1(128,64)
        self.down47 = Down1(192, 64)
    ...
    def forward(self, x):
        ...
        x = self.conv3(x)  # out: B * 24 * 56 * 56    128
        ...
        for head in self.heads:
            ...
            # if head == 'hm':
                    ...
                    ret[head] = self.__getattr__(head)(stage47)
            # else:
