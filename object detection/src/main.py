...
def main(opt):
  ...
  test_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/test")
  test_half_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/test_self")  # 写错了，把half记成了self，只能将错就错下去
  test_recall_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/test_recall")
  test_easy_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/test_easy")
  test_medium_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/test_medium")
  test_hard_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/test_hard")
  train_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/train/loss")
  train_hmloss_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/train/hmloss")
  train_segloss_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/train/segloss")
  val_writer = SummaryWriter(log_dir="runs72.0_MultyFeatureAndTorchcatHm/val")
  best = 0.6834
  best_half = 0.7794
  best_easy = 0.8314
  best_medium = 0.7
